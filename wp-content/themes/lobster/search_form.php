...
.search-widget select {
    ...
    background: #ffffff url("https://www.travelnow.com/templates/457656/static/0/default/images/widgets/searchwidget/control-bg.jpg") repeat-x left top;
...
.search-widget .calendar-icon {
    background: url("https://www.travelnow.com/templates/457656/static/17/default/images/widgets/searchwidget/ico-calendar.png") right top no-repeat;
    width: 21px;
    height: 22px;
    float: right;
    cursor: pointer;
        ...
        <div class="search-widget-inner">
            <div class="predefined-destinations-block">
                ...
                <ul id="predefined-destinations">
                            <li>
                                <input type="radio" class="radio" id="AREA-572b0850-4e3f-469b-87b2-c17ed3ea049b|cities|New York, New York, United States" name="predefined" value="New York, New York, United States"/>
                                <label for="AREA-572b0850-4e3f-469b-87b2-c17ed3ea049b|cities|New York, New York, United States">New York</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-7732a217-1867-4f13-83ac-51e94c65bb4a|cities|Orlando, Florida, United States" name="predefined" value="Orlando, Florida, United States"/>
                                <label for="AREA-7732a217-1867-4f13-83ac-51e94c65bb4a|cities|Orlando, Florida, United States">Orlando</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-5603b51f-efae-483e-9073-e7cecb95f048|cities|San Francisco, California, United States" name="predefined" value="San Francisco, California, United States"/>
                                <label for="AREA-5603b51f-efae-483e-9073-e7cecb95f048|cities|San Francisco, California, United States">San Francisco</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-152d9a9d-7729-4552-8b2a-1392b637d0dd|cities|San Diego (AREA), CA, United States" name="predefined" value="San Diego (AREA), CA, United States"/>
                                <label for="AREA-152d9a9d-7729-4552-8b2a-1392b637d0dd|cities|San Diego (AREA), CA, United States">San Diego (AREA)</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-809003ea-ab88-410b-a419-a3a28e656963|cities|Miami, Florida, United States" name="predefined" value="Miami, Florida, United States"/>
                                <label for="AREA-809003ea-ab88-410b-a419-a3a28e656963|cities|Miami, Florida, United States">Miami</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-7f81b48e-3872-405e-9cd1-c609de0e733f|cities|Los Angeles (AREA), CA, United States" name="predefined" value="Los Angeles (AREA), CA, United States"/>
                                <label for="AREA-7f81b48e-3872-405e-9cd1-c609de0e733f|cities|Los Angeles (AREA), CA, United States">Los Angeles (AREA)</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-7eef0188-e4dc-4b45-b4a7-57e3df950e1f|cities|Cancun, Mexico" name="predefined" value="Cancun, Mexico"/>
                                <label for="AREA-7eef0188-e4dc-4b45-b4a7-57e3df950e1f|cities|Cancun, Mexico">Cancun</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-76ac2a5c-6ab7-4b6c-b618-387169a79f5e|cities|Honolulu, Hawaii, United States" name="predefined" value="Honolulu, Hawaii, United States"/>
                                <label for="AREA-76ac2a5c-6ab7-4b6c-b618-387169a79f5e|cities|Honolulu, Hawaii, United States">Honolulu</label>
                            </li>
                            <li>
                                <input type="radio" class="radio" id="AREA-4fded4ff-af4a-41b7-976b-bd5bd436f135|cities|Las Vegas, NV, United States" name="predefined" value="Las Vegas, NV, United States"/>
                                <label for="AREA-4fded4ff-af4a-41b7-976b-bd5bd436f135|cities|Las Vegas, NV, United States">Las Vegas</label>
                            </li>
                </ul>
            </div>
...
var SearchWidget = {
    ...
    decorateSearch : function() {
        ...
        self.YAHOO.util.Event.on(self.YAHOO.util.Dom.get(self.SEARCH_ID), "click", function() {
            ...
            var url = "https://www.travelnow.com/templates/457656/searchWidget?autosearch=true";
