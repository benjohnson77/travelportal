		...
		<div class="dest-list list-group tours">
			...
			<a href="<?php echo get_the_permalink(); ?>" class="list-group-item tour-list-item nopadding">
			    ...
			    <div class="col-md-9 nopadding text_block">
			    	...
			    	<button class="btn btn-xs pull-right">Read More</button>
			    </div>
			</a>
			
		<?php endforeach; ?>
		</div>	
		<div class="dest-header list-group-item" style="background: url('<?php echo bloginfo('template_directory').'/'.$feed['image']; ?>') no-repeat 80%;
